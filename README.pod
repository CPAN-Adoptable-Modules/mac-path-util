...
B<This is an abandoned module. There is no support. Adopt it on CPAN if you
want to fix it.>
...
=item *	L<https://github.com/CPAN-Adoptable-Modules/Mac-Path-Util>

=back

=head2 Getting help

I've abandoned this module. Mac Classic is a distant memory. I don't
provide any support for this module.
